 ...
 *                읽기 통로 : 데이터가 저장된 위치로부터 프로그램에서 데이터를 읽어 들이긴 위한 연결
 ...
 *  FilterInputStream  FilterOtputStream    BufferdReader         BufferdWriter                                   
 *   |                   |
 *  BufferdInputStream  BufferdOutputStream
 *  ---------------------------------------
 *  ObjectInputStream / ObjectOutputDStream
 * 
 *  *** 모드 (mode) => r, w, a
 *                   read/write/append
 *                   ---- ----- ------
 ...
 *      File 사용방법
 *        = 생산방법
 *         File file = new File("c:\\javaDev\\back.org)
 *            파일 정보 읽기
 ...
 *           ***createNewFile()
 *        = 파일 삭제
 *          ***delete() => 한개만 (파일이 있는 데렉토리는 삭제가 안된다)
 *                              => 파일을 먼저 삭제 / 디렉토리 삭제
 *        = 파일이나 디렉토리의 존재여부
 *           ***boolean exists()
 *        = 수정날짜
