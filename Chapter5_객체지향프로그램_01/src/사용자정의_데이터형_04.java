...
public class 사용자정의_데이터형_04 {
	...
	public static void main(String[] args) {
		...
		System.out.println("노래명 : " + music[maxIndex].title);
		System.out.println("가수명 : " + music[maxIndex].singer);
		System.out.println("앨범 : " + music[maxIndex].album);
		System.out.println("상태 : " + music[maxIndex].state);
		System.out.println("범위 : ▲ " + music[maxIndex].modify);
		...
		System.out.println("노래명 : " + music[minIndex].title);
		System.out.println("가수명 : " + music[minIndex].singer);
		System.out.println("앨범 : " + music[minIndex].album);
		System.out.println("상태 : " + music[minIndex].state);
		System.out.println("범위 : ▽ " + music[minIndex].modify);
	}
