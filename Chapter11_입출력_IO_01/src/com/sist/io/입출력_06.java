...
public class 입출력_06 {
	...
	public static void main(String[] args) throws Exception {
		...
		prop.load(new FileInputStream("C:\\javaDev\\javaStudy\\Chapter11_입출력_IO_01\\src\\com\\sist\\io\\db.properties"));
		...
		prop4.load(new FileInputStream("C:\\javaDev\\javaStudy\\Chapter11_입출력_IO_01\\info.properties"));
